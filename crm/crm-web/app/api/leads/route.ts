...
// GET = lista de leads pro painel (com a última mensagem). Requer login.
...
// POST = captura de lead. Público (usado pelo formulário do site) OU manual (logado).
export async function POST(req: Request) {
  ...
  const source = body.source === "manual" ? "manual" : "site-form";
